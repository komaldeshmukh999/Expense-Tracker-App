...
export default function Home() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if((formData.amount) >= 10000){
        alert('You have reached your monthly expense limit. Upgrade to Premium to continue.')
      }


      dispatch(setTotalExpenses(parseInt(totalAmount) + parseInt(formData.amount)));
  ...
  <div className={classes.expenseCards}>
    {expenseList.map((expense) => (
      <div key={expense.id} className={classes.expenseCard}>
        ...
        <div className={classes.cardActions}>
          <button className={classes.edit} onClick={() => handleUpdate(expense)}>
            Edit
          </button>
  ...
  <p className={classes.noExpenses}>No expenses found.</p>
)}
        {
          isPremium &&
